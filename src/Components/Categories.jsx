...
const upl = "http://localhost:4000:api/category/add-category";
const Categories = () => {
  ...
  const handleImageChange = async (e) => {
    ...
    setCategory({ ...Category, image: uploadurlimage.url });
      ...
      <div className="flex  justify-center items-center min-h-screen  bg-gray-100">
        <div className=" p-8 rounded-lg shadow-md w-full mt-10  max-w-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full cursor-pointer bg-orange-500 text-white py-2 rounded hover:bg-orange-600 transition duration-200"
            >
              {loading ? (
                <div role="status">
                  <svg
